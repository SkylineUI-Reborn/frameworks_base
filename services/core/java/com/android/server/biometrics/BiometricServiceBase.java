...
public abstract class BiometricServiceBase extends SystemService
    ...
    public void handleAuthenticated(boolean authenticated,
        ...
        if (client != null && isKeyguard(mCurrentClient.getOwnerString())
                && mWindowManagerPolicy != null && authenticated && com.android.internal.util.pixel.Utils.hasPowerButtonFingerprint(mContext)) {
    ...
    protected void startCurrentClient(int cookie) {
        ...
        if (!isKeyguard(mCurrentClient.getOwnerString())
                && (this.mCurrentClient.getClass().getSuperclass().getSimpleName().equals("AuthenticationClientImpl")
                    ...
                    && com.android.internal.util.pixel.Utils.hasPowerButtonFingerprint(mContext)) {
