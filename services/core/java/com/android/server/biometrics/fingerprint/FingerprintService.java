...
public class FingerprintService extends BiometricServiceBase {
    ...
    private final class FingerprintServiceWrapper extends IFingerprintService.Stub {
        ...
        public void authenticate(final IBinder token, final long opId, final int userId,
            ...
            if (com.android.internal.util.pixelish.Utils.hasPowerButtonFingerprint(mContext))
    ...
    private IBiometricsFingerprintClientCallback mDaemonCallback =
        ...
        public void onAuthenticated(final long deviceId, final int fingerId, final int groupId,
            ...
            mHandler.post(() -> {
                ...
                if (!isScreenOnWhenFingerdown && mListenPowerKey.getPowerKeyDown() == 0 && com.android.internal.util.pixelish.Utils.hasPowerButtonFingerprint(mContext)) {
    ...
    public FingerprintService(Context context) {
        ...
        if (com.android.internal.util.pixelish.Utils.hasPowerButtonFingerprint(context)) {
